 ...
 */
@Component
public class MotorcycleModelDaoJdbc implements MotorcycleModelDao {
    DataSource dataSource;
    ManufacturerDao manufacturerDao;

    public MotorcycleModelDaoJdbc(DatabaseManager databaseManager, ManufacturerDao manufacturerDao) {
    ...
    public MotorcycleModel get(int id) {
        try (Connection connection = dataSource.getConnection()) {
            String sql = "SELECT * FROM motorcycle_model WHERE id = ?";
    ...
    public List<MotorcycleModel> getAll() {
        try (Connection connection = dataSource.getConnection()) {
            String sql = "SELECT * FROM motorcycle_model ORDER BY id";
