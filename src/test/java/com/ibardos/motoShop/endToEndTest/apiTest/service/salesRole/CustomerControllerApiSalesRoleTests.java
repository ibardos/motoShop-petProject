...
/**
 * Test class, containing End-to-End tests against API endpoints in CustomerController, authenticated with Sales role.
 */
...
public class CustomerControllerApiSalesRoleTests {
    @LocalServerPort
    private int port;
    ...
    @Test
    @Order(1)
    void add_newValidCustomer_statusCode201WithProperJson() throws Exception {
        // Arrange
    ...
    @Test
    @Order(2)
    void add_newInvalidCustomer_statusCode400() throws Exception {
        // Arrange
        String url = baseUrl + "service/customer/add";
