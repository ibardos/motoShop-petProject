...
/**
 * Test class, containing End-to-End tests against API endpoints in CustomerController, authenticated with Admin role.
 */
...
public class CustomerControllerApiAdminRoleTests {
    @LocalServerPort
    private int port;
