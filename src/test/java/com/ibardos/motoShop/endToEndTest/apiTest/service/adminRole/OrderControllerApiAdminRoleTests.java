...
/**
 * Test class, containing End-to-End tests against API endpoints in OrderController, authenticated with Admin role.
 */
...
public class OrderControllerApiAdminRoleTests {
    ...
    @Test
    @Order(16)
    void delete_orderWithValidId_statusCode204() throws Exception {
        // Arrange
    ...
    @Test
    @Order(17)
    void delete_orderWithInvalidId_statusCode404() throws Exception {
        // Arrange
